...
def index(request):
    dict = {}
    return render(request, 'User_Authentication/index.html', context=dict)
...
def student(request):
    ...
    dict = {}
    return render(request, 'User_Authentication/Student_info.html', context=dict)
